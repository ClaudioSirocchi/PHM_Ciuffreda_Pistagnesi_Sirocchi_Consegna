...
% Auto-generated by MATLAB on 08-May-2024 17:02:34
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            featureValues = [ClearanceFactor,CrestFactor,ImpulseFactor,Kurtosis,Mean,PeakValue,RMS,SINAD,SNR,Skewness,THD];

            % Package computed features into a table.
            featureNames = {'ClearanceFactor','CrestFactor','ImpulseFactor','Kurtosis','Mean','PeakValue','RMS','SINAD','SNR','Skewness','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [Mean,SINAD,SNR,Skewness];

            % Package computed features into a table.
            featureNames = {'Mean','SINAD','SNR','Skewness'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [SNR,Skewness];

            % Package computed features into a table.
            featureNames = {'SNR','Skewness'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [Mean,SINAD,SNR,Skewness,THD];

            % Package computed features into a table.
            featureNames = {'Mean','SINAD','SNR','Skewness','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,CrestFactor,ImpulseFactor,Mean,THD];

            % Package computed features into a table.
            featureNames = {'ClearanceFactor','CrestFactor','ImpulseFactor','Mean','THD'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/Kurtosis","FRM_1/Case_sigstats/Mean","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/RMS","FRM_1/Case_sigstats/SINAD","FRM_1/Case_sigstats/SNR","FRM_1/Case_sigstats/Skewness","FRM_1/Case_sigstats/THD","FRM_1/Case_sigstats_1/Mean","FRM_1/Case_sigstats_1/SINAD","FRM_1/Case_sigstats_1/SNR","FRM_1/Case_sigstats_1/Skewness","FRM_1/Case_sigstats_2/SNR","FRM_1/Case_sigstats_2/Skewness","FRM_1/Case_sigstats_3/SNR","FRM_1/Case_sigstats_4/Mean","FRM_1/Case_sigstats_4/SINAD","FRM_1/Case_sigstats_4/SNR","FRM_1/Case_sigstats_4/Skewness","FRM_1/Case_sigstats_4/THD","FRM_1/Case_sigstats_5/Kurtosis","FRM_1/Case_sigstats_6/ClearanceFactor","FRM_1/Case_sigstats_6/CrestFactor","FRM_1/Case_sigstats_6/ImpulseFactor","FRM_1/Case_sigstats_6/Mean","FRM_1/Case_sigstats_6/THD","FRM_1/Case_ps_spec/BandPower"];
