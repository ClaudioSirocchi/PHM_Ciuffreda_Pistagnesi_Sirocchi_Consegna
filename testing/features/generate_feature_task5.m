...
% Auto-generated by MATLAB on 14-May-2024 14:15:20
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            featureValues = [CrestFactor,ImpulseFactor,Kurtosis,Mean,PeakValue,RMS,Skewness,THD];

            % Package computed features into a table.
            featureNames = {'CrestFactor','ImpulseFactor','Kurtosis','Mean','PeakValue','RMS','Skewness','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [CrestFactor,PeakValue,RMS,THD];

            % Package computed features into a table.
            featureNames = {'CrestFactor','PeakValue','RMS','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,Mean,PeakValue,RMS];

            % Package computed features into a table.
            featureNames = {'ClearanceFactor','Mean','PeakValue','RMS'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [CrestFactor,PeakValue];

            % Package computed features into a table.
            featureNames = {'CrestFactor','PeakValue'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [Mean,PeakValue,RMS,THD];

            % Package computed features into a table.
            featureNames = {'Mean','PeakValue','RMS','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [PeakValue,Skewness];

            % Package computed features into a table.
            featureNames = {'PeakValue','Skewness'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/Kurtosis","FRM_1/Case_sigstats/Mean","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/RMS","FRM_1/Case_sigstats/Skewness","FRM_1/Case_sigstats/THD","FRM_1/Case_sigstats_1/CrestFactor","FRM_1/Case_sigstats_1/PeakValue","FRM_1/Case_sigstats_1/RMS","FRM_1/Case_sigstats_1/THD","FRM_1/Case_sigstats_2/ClearanceFactor","FRM_1/Case_sigstats_2/Mean","FRM_1/Case_sigstats_2/PeakValue","FRM_1/Case_sigstats_2/RMS","FRM_1/Case_sigstats_3/CrestFactor","FRM_1/Case_sigstats_3/PeakValue","FRM_1/Case_sigstats_4/Mean","FRM_1/Case_sigstats_4/PeakValue","FRM_1/Case_sigstats_4/RMS","FRM_1/Case_sigstats_4/THD","FRM_1/Case_sigstats_5/PeakValue","FRM_1/Case_sigstats_5/Skewness","FRM_1/Case_sigstats_6/PeakValue","FRM_1/Case_ps_spec/BandPower","FRM_1/Case_ps_1_spec/BandPower","FRM_1/Case_ps_2_spec/BandPower","FRM_1/Case_ps_3_spec/BandPower","FRM_1/Case_ps_4_spec/BandPower"];
