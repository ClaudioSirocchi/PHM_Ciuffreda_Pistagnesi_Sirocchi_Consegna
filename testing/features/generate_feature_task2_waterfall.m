...
% Auto-generated by MATLAB on 09-May-2024 16:54:59
...
while hasdata(outputEnsemble)
    ...
    % Read signals.
    Case_full = readMemberData(member,"Case",["TIME","P1","P2","P5","P3","P6","P7"]);
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [RMS,SNR,ShapeFactor,Std];

            % Package computed features into a table.
            featureNames = {'RMS','SNR','ShapeFactor','Std'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [CrestFactor,Kurtosis,THD];

            % Package computed features into a table.
            featureNames = {'CrestFactor','Kurtosis','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [Mean,RMS,ShapeFactor,Std,THD];

            % Package computed features into a table.
            featureNames = {'Mean','RMS','ShapeFactor','Std','THD'};
...
selectedFeatureNames = ["FRM_1/Case_sigstats/ClearanceFactor","FRM_1/Case_sigstats/CrestFactor","FRM_1/Case_sigstats/ImpulseFactor","FRM_1/Case_sigstats/Kurtosis","FRM_1/Case_sigstats/Mean","FRM_1/Case_sigstats/PeakValue","FRM_1/Case_sigstats/RMS","FRM_1/Case_sigstats/SINAD","FRM_1/Case_sigstats/SNR","FRM_1/Case_sigstats/ShapeFactor","FRM_1/Case_sigstats/Skewness","FRM_1/Case_sigstats/Std","FRM_1/Case_sigstats/THD","FRM_1/Case_sigstats_1/RMS","FRM_1/Case_sigstats_1/SNR","FRM_1/Case_sigstats_1/ShapeFactor","FRM_1/Case_sigstats_1/Std","FRM_1/Case_sigstats_2/SNR","FRM_1/Case_sigstats_4/Kurtosis","FRM_1/Case_sigstats_5/CrestFactor","FRM_1/Case_sigstats_5/Kurtosis","FRM_1/Case_sigstats_5/THD","FRM_1/Case_sigstats_6/Mean","FRM_1/Case_sigstats_6/RMS","FRM_1/Case_sigstats_6/ShapeFactor","FRM_1/Case_sigstats_6/Std","FRM_1/Case_sigstats_6/THD","FRM_1/Case_ps_spec/BandPower","FRM_1/Case_ps_1_spec/BandPower","FRM_1/Case_ps_4_spec/BandPower"];
