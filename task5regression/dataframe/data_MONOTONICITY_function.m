...
% Auto-generated by MATLAB on 14-May-2024 11:27:01
...
while hasdata(outputEnsemble)
    ...
    % Read signals.
    Case_full = readMemberData(member,"Case",["TIME","P1","P2","P3","P5","P4","P6","P7"]);
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [ClearanceFactor,ImpulseFactor,Kurtosis,Mean,PeakValue,RMS,SNR,ShapeFactor,Skewness,Std,THD];

            % Package computed features into a table.
            featureNames = {'ClearanceFactor','ImpulseFactor','Kurtosis','Mean','PeakValue','RMS','SNR','ShapeFactor','Skewness','Std','THD'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [PeakValue,RMS];

            % Package computed features into a table.
            featureNames = {'PeakValue','RMS'};
        ...
        try
            ...
            % Concatenate signal features.
            featureValues = [Mean,PeakValue,RMS,Skewness];

            % Package computed features into a table.
            featureNames = {'Mean','PeakValue','RMS','Skewness'};
